...
export default function KuryeGiris({ toastGoster }) {
  ...
  const girisYap = async (e) => {
    ...
    try {
      ...
      if (!bulundu) toastGoster("Telefon veya şifre hatalı", "hata");
    } catch (err) {
      ...
      <div className="giris-kutu">
        ...
        <form onSubmit={girisYap}>
          <div className="form-grup">
            ...
            <input className="form-input" type="tel" placeholder="05XX XXX XX XX" value={telefon} onChange={(e) => setTelefon(e.target.value)} autoFocus />
          </div>
          <div className="form-grup">
